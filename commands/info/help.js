...
const CATEGORIES = [
    ...
    },
    {
        ...
        commands: [
            ...
            ['confess send', 'Send an anonymous confession — lands in their /letter inbox.'],
            ['confess reset','Clear a stuck confession so you can try again.'],
            ['dare',    'Dare someone to do something ridiculous.'],
            ['draw',    'Draw a tarot card from the Moon Consort\'s deck.'],
            ['fortune', 'Daily moon fortune. May reward a butterfly or blessing.'],
            ['gather',  'Search the moonlit garden for butterflies. 6h cooldown.'],
            ['roast',   'Roast someone lovingly.'],
            ['seduce',  'Turn your full attention on someone. Results vary.'],
            ['ship',    'Calculate compatibility between two people.'],
            ['tod truth', 'Give someone a truth question.'],
            ['tod dare',  'Give someone a dare.'],
        ],
    },
    {
        name: '📜 Info',
